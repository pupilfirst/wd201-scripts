...
We will start the simple Node.ss application we've created in the [Running our first program](../../introduction-to-nodejs/running-first-program/README.md) lesson.
